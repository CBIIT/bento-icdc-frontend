...
export const updateStat = stat => {
  ...
  const numberOfCaseFiles =
    numberOfFiles == null || numberOfStudyFiles == null
      ? undefined
      : numberOfFiles - numberOfStudyFiles;
  return {
    ...stat,
    numberOfFiles:
      numberOfCaseFiles == null ? undefined : Math.max(numberOfCaseFiles, 0),
