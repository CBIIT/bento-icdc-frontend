...
function AddToCartDialogView(props) {
  const { open, numberOfRowsSelected, onYesClick, onNoClick, classes } = props;
          ...
          {numberOfRowsSelected !== undefined &&
            (numberOfRowsSelected.activeTab !== "Files" ? (
              <DialogContentText id="alert-dialog-description">
                Add all files for the {numberOfRowsSelected.count || 0} selected{" "}
                {numberOfRowsSelected.activeTab || "Files"} to My Files?
              </DialogContentText>
            ) : (
              <DialogContentText id="alert-dialog-description">
                Add all {numberOfRowsSelected.count || 0} files to My Files?
              </DialogContentText>
            ))}
        </DialogContent>
        <DialogActions>
