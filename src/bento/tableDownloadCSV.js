...
query fileOverview($file_uuids: [String], $associations: [String], $offset: Int = 0, $first: Int = 10, $order_by:String ="file_name"){
    fileOverview(file_uuids: $file_uuids, associations: $associations, offset: $offset,first: $first, order_by: $order_by) {
      file_name
      file_type
      sample_id
      association
