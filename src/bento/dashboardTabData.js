...
export const tableContainers = [
  {
    ...
    dataField: 'dataCase',
    api: GET_CASES_OVERVIEW_QUERY,
    selectAllButtonText: 'Add Associated Files 1',
    paginationAPIField: 'caseOverview',
    count: 'numberOfCases',
    dataKey: 'case_id',
    defaultSortField: 'case_id',
  ...
  },
  {
    ...
    dataField: 'dataSample',
    api: GET_SAMPLES_OVERVIEW_QUERY,
    selectAllButtonText: 'Example text 2',
    count: 'numberOfSamples',
    paginationAPIField: 'sampleOverview',
    dataKey: 'sample_id',
    defaultSortField: 'sample_id',
  ...
  },
  {
    ...
    dataField: 'dataFile',
    api: GET_FILES_OVERVIEW_QUERY,
    selectAllButtonText: 'Add all button Tab 3',
    paginationAPIField: 'fileOverview',
    defaultSortField: 'file_name',
    defaultSortDirection: 'asc',
    count: 'numberOfFiles',
  ...
  },
  {
    ...
    dataField: 'dataStudyFile',
    api: GET_FILES_OVERVIEW_QUERY,
    selectAllButtonText: 'Add all button Tab 4',
    paginationAPIField: 'fileOverview',
    defaultSortField: 'file_name',
    defaultSortDirection: 'asc',
    count: 'numberOfStudyFiles',
