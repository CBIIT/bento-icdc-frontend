...
export const programs = [
  {
    ...
    program_short_description:
      'The COP is a core resource for CCR investigators.',
  },
  {
    type: 'program',
    program_id: 'PRECINCT',
    ...
    program_short_description:
      'The Pre-medical Cancer Immunotherapy Network for Canine Trials (PRECINCT) facilitates the performance',
  },
  {
    type: 'program',
    program_id: 'CMCP',
    ...
    program_short_description:
      'The Comparative Molecular Characterization Program serves as an umbrella program under which studies lacking any pre-designated',
  },
];
...
export const studies = [
  {
    ...
    accession_id: '000001',
    clinical_study_name:
      'Preclinical Comparison of Three Indenoisoquinoline Candidates in Tumor-Bearing Dogs',
  ...
  },
  {
    ...
    accession_id: '000007',
    clinical_study_name:
      'Molecular Homology and Differences Between Spontaneous Canine Mammary Cancer and Human Breast Cancer',
    clinical_study_type: 'Genomics',
    program_id: 'CMCP',
    program_name: 'Comparative Molecular Characterization Program',
  },
  {
    ...
    accession_id: '000006',
    clinical_study_name:
      'A Multi-Platform Sequencing Analysis of Canine Appendicular Osteosarcoma.',
    clinical_study_type: 'Genomics',
    program_id: 'CMCP',
    program_name: 'Comparative Molecular Characterization Program',
  },
  {
    ...
    accession_id: '000016',
    clinical_study_name:
      'Comparative analysis using whole genome bisulfite sequencing of human and canine osteosarcoma',
    clinical_study_type: 'Genomics',
    program_id: 'CMCP',
    program_name: 'Comparative Molecular Characterization Program',
  },
...
export async function queryResultAPI(datafield, input) {
  ...
  if (data[datafield]?.length > 0) {
    const updateDataType = data[datafield].map(item => ({
      ...item,
      input,
      type: mapObjectKey[item.type],
    }));
...
export const modelModel = [
  {
    type: 'model',
    highlight:
      'Number of passages (splits) between the original tissue and this model.',
    node_name: 'Program',
