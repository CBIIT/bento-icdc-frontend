...
export const GET_SEARCH_NODECOUNTS = gql`
  query nodeCounts(
    ...
    subjectCountByDiagnosesFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
    ...
    subjectCountByRecurrenceScoreFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
    ...
    subjectCountByTumorSizeFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
    ...
    subjectCountByChemotherapyRegimenFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
    ...
    subjectCountByEndocrineTherapyFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
    ...
    subjectCountByFileTypeFromLists(
      subject_ids: $subject_ids
      sample_ids: $sample_ids
      file_ids: $file_ids
      file_names: $file_names
