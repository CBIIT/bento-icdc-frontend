...
const LineText = (props) => {
  ...
  return text
    .split("\n")
    .map((str, index) => <div key={`lineText-${index}`}>{str}</div>);
};
        ...
        <div className={classes.imageWithCaptionContainer}>
          ...
          >
            <img
              src={item.img}
              alt={item.alt}
              className={classes.imageWithCaption}
            />
          </div>
          <div
            style={{
...
const LandingView = ({ classes, pageData }) => {
      ...
      <div className={classes.page}>
        <div className={classes.container}>
          <Grid
            ...
            spacing={16}
            direction="row"
            className={cn(classes.paddingTop30)}
          >
            <Grid
              item
              lg={2}
            ...
            >
              {pageData.tabs.map((item, index) => (
                <TabPanel
                  key={`landingView-tabPanel-${index}`}
                  value={currentTab}
                  index={index}
                >
                  <Grid container className={classes.tabContainer} spacing={1}>
                    ...
                    >
                      <div
                        className={
                          index === 3
                            ? classes.spotLightcarouselTitle
                            : classes.carouselTitle
                        }
                      >
