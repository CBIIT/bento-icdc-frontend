...
export const JBrowsePageLink = styled(Link)(({ isInvlaid, disable }) => {
...
export const JBrowseButton = styled(Button)(({ isInvlaid, disable }) => ({
  borderRadius: '10px',
  width: '210px',
  lineHeight: '37px',
  fontSize: '16px',
...
export const HelpIconImg = styled('img')(({ customStyle }) => ({
  ...customStyle,
}));
