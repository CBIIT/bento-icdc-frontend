    ...
    ({
      ...
      return (
        <>
          ...
          >
            <CustomAccordionSummary classes={styledClasses} expand={expand}>
              <div>
                <span className={styledClasses.summaryTextLebal}>
                  Repository:
                </span>
                <span className={styledClasses.summaryTextTitle}>{title}</span>
                <ToolTip title="Click to view external link in new tab">
                  <a href={repositoryUrl} target="_blank" rel="noreferrer">
                    <img
                      className={styledClasses.hyperlink}
                      src={hyperlinkIcon}
                      alt="exp-icon"
                    />
                  </a>
            ...
            <AccordionDetails
              className={styledClasses.expansionPanelDetailsRoot}
            >
              <PaginatedTableView
                isServer={false}
                tblRows={tableRows}
    ...
    <ThemeProvider theme={createTheme(customTheme)}>
      <div className={classes.supportDataContainer}>
        <Grid container justifyContent="center">
          {supportDataList.map((item, index) => (
            <CustomAccordian
