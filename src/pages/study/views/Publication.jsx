...
const Publication = ({ classes, publications, display }) => {
  ...
  const publicationList = (startIndex, endIndex) => {
    const finalIndex =
      publications.length - startIndex > display.numbOfPublishPerView
        ? endIndex
        : publications.length;
              ...
              {display.views.map((attr) =>
                attr.type === "link" ? (
                  <>
                    ...
                    {publication[attr.key] !== null &&
                    publication[attr.key] !== undefined ? (
          ...
          <Grid container className={classes.gridContainer}>
            ...
            <Grid item lg={6} md={6} sm={6} xs={12}>
              ...
              >
                <Grid item xs={12}>
                  {publications &&
                    publications.length > display.numbOfPublishPerView &&
                    publicationList(
                      display.numbOfPublishPerView,
