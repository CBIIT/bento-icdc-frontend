...
const ProgramCard = ({ data = {}, classes, index }) => {
  const {
  ...
  return (
    ...
    >
      ...
      <Grid item xs={11} className={classes.propertyContainer}>
        ...
        <Grid item xs={12}>
          <span className={classes.title}>Program Acronym:</span>
          <span className={classes.content}>{programId}</span>
        </Grid>
        <Grid item xs={12}>
          <span className={classes.title}>Program Description:</span>
          <span className={classes.content}>{description}</span>
        </Grid>
        <Grid item xs={12}>
          <span className={classes.title}>Program URL:</span>
