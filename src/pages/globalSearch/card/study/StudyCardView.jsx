...
const StudyCardView = ({ data = {}, classes, index }) => {
  const {
      ...
      <Grid item xs={11} className={classes.propertyContainer}>
        ...
        <Grid item xs={12}>
          ...
          <Link to={`/program/${programId}`}>
            <span className={classes.contentLink}>{programId}</span>
          </Link>
        </Grid>
        <Grid item xs={12}>
          <span className={classes.title}>Accession ID:</span>
          <span className={classes.content}>{accessionID}</span>
        </Grid>
        <Grid item xs={12}>
          <span className={classes.title}>Study Name:</span>
          <span className={classes.content}>{studyName}</span>
        </Grid>
        <Grid item xs={12}>
          <span className={classes.title}>Study Type:</span>
          <span className={classes.content}>{studyType}</span>
        </Grid>
      </Grid>
    </Grid>
  );
