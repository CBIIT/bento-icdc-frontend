...
const DownloadFileManifestDialog = React.forwardRef(
  ({ onClose, selectedValue, open, filesId, allFiles }, ref) => {
      ...
      >
        ...
        <CustomDialogContent>
          <DialogContentText classes={{ root: classes.contentText }}>
            If you wish to annotate the file manifest with comments regarding
            the files included, enter them here. Comments will be saved as part
          ...
          >
            <img src={DownloadFileManifestIcon} alt="download icon" />
          </Button>
        </CustomDialogContent>
      </Dialog>
    );
...
DownloadFileManifestDialog.displayName = "DownloadFileManifestDialog";
