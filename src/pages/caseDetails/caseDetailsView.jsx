...
const CaseDetail = ({ classes, data }) => {
  ...
  return (
    <>
        ...
        <div className={classes.header}>
          ...
          !(
            ...
            <div className={classes.headerTitle}>
              ...
              <div
                className={cn(
                  classes.headerMSubTitle,
                  classes.headerSubTitleCate,
                )}
              >
                {caseDetail.patient_first_name === "" ||
                caseDetail.patient_first_name === null ? (
                ...
                caseDetail.enrollment.initials !== null ? (
                  <span>
                    <span
                      className={cn(
                        classes.headerSubTitleCate,
                        classes.paddingLeft8,
                        classes.paddingBottm17,
                      )}
                    >
                      INITIALS{" "}
                    </span>
          ...
          <Grid container spacing={4} className={classes.marginTopBottom3}>
            ...
            >
              ...
              >
                ...
                {caseDetail.diagnoses.map((diagnosis, index) => (
                  <Grid
                    key={`diagnosis-${index}`}
                    container
                    className={classes.detailContainerItems}
                  >
                    <Grid item xs={12}>
                      <Grid container spacing={4}>
                        <Grid item xs={6}>
                    ...
                    <Grid item xs={12}>
                      <Grid container spacing={4}>
                        ...
                        <Grid item xs={6} className={classes.content}>
                          ...
                          diagnosis.histological_grade === null
                            ? ""
                            : diagnosis.histological_grade}
                        </Grid>
                      </Grid>
                ...
                <Grid container className={classes.detailContainerItems}>
                      ...
                      <Grid item xs={6} className={classes.content}>
                        {caseDetail.cohort
                          ? caseDetail?.cohort.study_arm
                            ? caseDetail?.cohort.study_arm.arm
                            : notProvided
                          : notProvided}
                      </Grid>
                    </Grid>
                  ...
                  <Grid item xs={12}>
                    <Grid container spacing={4}>
                      ...
                      <Grid item xs={6} className={classes.content}>
                        {caseDetail.enrollment
                          ? caseDetail.enrollment.patient_subgroup
                          : notProvided}
                      </Grid>
                    </Grid>
                  </Grid>
      ...
      <div
        id="case_detail_table_associated_samples"
