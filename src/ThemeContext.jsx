...
const lightThemeV4 = createThemeV4({
  ...themes.light,
  ...overrides,
  ...typography,
});
const darkThemeV4 = createThemeV4({
  ...themes.dark,
  ...overrides,
  ...typography,
});

const lightThemeV5 = createThemeV5(
  adaptV4Theme({ ...themes.light, ...overrides, ...typography })
);
const darkThemeV5 = createThemeV5(
  adaptV4Theme({ ...themes.dark, ...overrides, ...typography })
);
